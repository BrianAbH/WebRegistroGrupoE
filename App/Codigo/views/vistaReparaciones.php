                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-warning" id="tooltip" 
                                    ...
                                    <span class="tooltiptext">Actualizar Reparacion</span>
                                </button>
                                
                                <!-- Botón para eliminar el cliente -->
                                <form action="" method="POST" style="display:inline;">
                                    <input type="hidden" name="id" value="<?= $row["Id_Reparacion"] ?>">
                                    <button type="submit" name="eliminar" value="1" class="btn btn-outline-danger" id="tooltip"  onclick="return confirm('¿Seguro que quieres eliminar este cliente?')">
                                        <i class="fa-solid fa-trash"></i>
                                        <span class="tooltiptext">Eliminar Reparacion</span>
                                    </button>
                                </form>
                            </td>
                        </tr>
