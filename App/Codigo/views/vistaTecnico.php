              ...
              <?php foreach ($resultado as $row): ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button 
                      type="button" class="btn btn-outline-warning" id="tooltip"  onclick="llenarFormulario(
                        '<?= $row["Id_Tecnico"] ?>',
                        '<?= $row["Cedula"] ?>',
                        '<?= $row["Nombres"] ?>',
                        '<?= $row["Apellidos"] ?>',
                        ...
                        <span class="tooltiptext">Actualizar Tecnico</span>
                    </button>
                    <!-- Botón para eliminar el técnico -->
                    <form action="" method="POST" style="display:inline;">
                      <input type="hidden" name="id" value="<?= $row["Id_Tecnico"] ?>">
                      <button type="submit" name="eliminar" value="1" class="btn btn-outline-danger" id="tooltip" onclick="return confirm('¿Seguro que quieres eliminar este Tecnico?')">
                        <i class="fa-solid fa-trash"></i>
                        <span class="tooltiptext">Eliminar Tecnico</span>
                      </button>
                    </form>
                  </td>
                </tr>
