            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-content">
                        ...
                        <select class="select" id="cliente" name="cliente" class="form-label" required>
                        ...
                        <?php foreach ($resultadoD as $row): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-outline-warning" id="tooltip" 
