    ...
    if($id == '' || $token == ''){
        ...
        if($token == $token_tmp){
            ...
            if($sql-> fetchColumn ()>0){
                ...
                det_proc_caracter AS det INNER JOIN caracteristicas AS cat ON
        ...
        <div class="container">
            <div class ="row">
                ...
                <div class="col-md-6 order-md-2">
                    ...
                    <?php if($descuento >0 ) { ?>
                        <p><del></del><?php echo MONEDA .number_format($precio,2,'.',','); ?></del></p>
                    ...
                    <div class="col-3 my-3">
                        <?php
                            while($row_cat = $sqlCaracter -> fetch(PDO::FETCH_ASSOC)){
                                ...
                                det_proc_caracter WHERE id_producto=? and id_caracteristica=?");
