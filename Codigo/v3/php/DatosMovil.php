...
include("../class/mostrarDatos/mostrarDatosMovil.php"); // Muestra los datos de los móviles desde la base de datos
include("../class/ingresarDatos/ingresarMovil.php"); // Procesa el formulario para ingresar nuevos móviles
?>
<!DOCTYPE html>
<html lang="en">
<head>
