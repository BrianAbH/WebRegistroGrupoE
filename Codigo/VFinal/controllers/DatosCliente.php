<?php
// Se incluyen los archivos necesarios para mostrar y agregar datos de clientes
include("../model/mostrarDatos/mostrarDatosCliente.php");  // Muestra los datos de los clientes
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="contenedor-datos">
    ...
    <div class="contenedor-form">
      <form action="" method="POST">
        <?php include("../model/ingresarDatos/ingresarCliente.php");  ?>
