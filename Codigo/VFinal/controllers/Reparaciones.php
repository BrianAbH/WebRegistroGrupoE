<?php
include("../model/mostrarDatos/mostrarDatosReparaciones.php");
include("../model/ingresarDatos/ingresarReparacion.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
                ...
                <div class="form-group">
                    ...
                    <div class="form-content">
                        ...
                        <select class="select" id="movil" name="movil" required>
                            ...
                            <?php while ($fila = $resultadoMovil->fetch_assoc()) { ?>
                                <option value="<?php echo $fila['Id_Movil'] ?>"><?php echo $fila['Nombre_Completo'] ?> <?php echo $fila['Modelo'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-content">
                        ...
                        <select class="select" id="tecnico" name="tecnico" required>
                            ...
                            <?php while ($fila = $resultadoTecnico->fetch_assoc()) { ?>
    ...
    <?php include("../controllers/helpers/footer.php") ?>
</html>