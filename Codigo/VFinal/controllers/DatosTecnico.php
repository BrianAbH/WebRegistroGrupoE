<?php
// Se incluyen los archivos necesarios para mostrar y agregar datos de técnicos
include("../model/mostrarDatos/mostrarDatosTecnico.php");  // Muestra los datos de los técnicos
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../css/DatosTecnico.css">
  ...
  <div class="contenedor-datos">
    ...
    <div class="contenedor-form">
      <form action="" method="POST">
        <?php include("../model/ingresarDatos/ingresarTecnico.php"); ?>
